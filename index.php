...
$('#cssmenu').prepend('<div id="indicatorContainer"><div id="pIndicator"><div id="cIndicator"></div></div></div>');
	...
	$( "#menu-button" ).click(function(){
        ...
        <div id="gordijnen"></div>
        <div id="nieuwstetrailer"><iframe id="ytplayer" type="text/html" width="790" height="400"
src="https://www.youtube.com/embed/xZY43QSx3Fk?autoplay=1&controls=0&showinfo=0&color=white"
frameborder="0" allowfullscreen></center></div>
